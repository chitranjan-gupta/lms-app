 ...
 * for example: if the APP_ENV is staging, the bundle id will be com.chitranjangupta.staging
 */
...
const client = z.object({
  ...
  STRIPE_MERCHANT_IDENTIFIER: z.string(),
  STRIPE_URL_SCHEME: z.string(),
  VEXO_API_KEY: z.string(),
});
...
const _clientEnv = {
  ...
  STRIPE_MERCHANT_IDENTIFIER: process.env.STRIPE_MERCHANT_IDENTIFIER,
  STRIPE_URL_SCHEME: process.env.STRIPE_URL_SCHEME,
